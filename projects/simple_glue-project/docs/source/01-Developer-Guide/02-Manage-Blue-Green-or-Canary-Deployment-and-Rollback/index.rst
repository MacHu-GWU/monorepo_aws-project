...
2. ``simple_glue/iac/define/lbd.py``: This is the CDK stack code where we declare the ``LIVE`` alias and use the value defined in ``"*.lambda_functions.*.live_version"`` as the target version.

.. literalinclude:: ../../../../simple_glue/iac/define/lbd.py
   :language: python
