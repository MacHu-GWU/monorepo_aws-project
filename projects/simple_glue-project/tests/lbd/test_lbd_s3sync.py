...
from simple_glue.lbd.s3sync import low_level_api
from simple_glue.tests.mock import BaseMockTest
...
if __name__ == "__main__":
    ...
    run_cov_test(__file__, "simple_glue.lbd.s3sync", preview=False)
