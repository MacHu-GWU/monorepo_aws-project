...
"""
this module is generated by https://pypi.org/project/tt4human = 0.2.1
"""
...
truth_table = TruthTable.from_csv(
    path=Path(__file__).absolute().parent.joinpath("simple_cdk_truth_table.tsv"),
)

if __name__ == "__main__":
    assert truth_table.evaluate(case={'step': 'CREATE_VIRTUALENV', 'semantic_branch_name': 'main', 'runtime_name': 'local', 'env_name': 'devops'}) is False