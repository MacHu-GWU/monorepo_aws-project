...
import moto
from simple_cdk1.logger import logger
from simple_cdk1.config.api import config
from simple_cdk1.lbd.s3sync import low_level_api
from simple_cdk1.tests.mock import BaseMockTest
...
if __name__ == "__main__":
    ...
    run_cov_test(__file__, "simple_cdk1.lbd.s3sync", preview=False)
