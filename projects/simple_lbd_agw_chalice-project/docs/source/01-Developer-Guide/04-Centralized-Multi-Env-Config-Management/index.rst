...
Below are the list of important files related to config management::
    ...
    ${HOME}/.projects/simple_lbd_agw_chalice/config-secret.json # include the sensitive config data, the ${HOME} is your user home directory
...
.. literalinclude:: ../../../../simple_lbd_agw_chalice/config/init.py
   :language: python
