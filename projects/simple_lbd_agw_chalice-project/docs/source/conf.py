# -*- coding: utf-8 -*-
#
# simple_lbd_agw_chalice documentation build configuration file, created by
...
import simple_lbd_agw_chalice as package
...
# Add data for Jinja2
try:
    from simple_lbd_agw_chalice.docs import doc_data
except:
    doc_data = dict()
