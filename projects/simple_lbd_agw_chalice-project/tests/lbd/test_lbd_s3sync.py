...
from simple_lbd_agw_chalice.lbd.s3sync import low_level_api
from simple_lbd_agw_chalice.tests.mock import BaseMockTest
...
if __name__ == "__main__":
    ...
    run_cov_test(__file__, "simple_lbd_agw_chalice.lbd.s3sync", preview=False)
