...
import dynamodbsnaplake.vendor.aws_ops_alpha.api as aws_ops_alpha
...
def deploy_config(check: bool = True):
    simple_config_project.deploy_config(
        ...
        check=check,
        step=simple_sfn_project.StepEnum.deploy_config.value,
...
def run_unit_test(check: bool = True):
    simple_python_project.run_unit_test(
        ...
        check=check,
        step=simple_sfn_project.StepEnum.run_code_coverage_test.value,
        truth_table=simple_sfn_project.truth_table,
        url=simple_sfn_project.google_sheet_url,
    )
...
def build_doc(check: bool = True):
    ...
    simple_python_project.build_doc(
        ...
        pyproject_ops=pyproject_ops,
        check=check,
        step=simple_sfn_project.StepEnum.build_documentation.value,
        truth_table=simple_sfn_project.truth_table,
        url=simple_sfn_project.google_sheet_url,
    )
...
def deploy_versioned_doc(check: bool = True):
    ...
    simple_python_project.deploy_versioned_doc(
        ...
        check=check,
        step=simple_sfn_project.StepEnum.update_documentation.value,
        truth_table=simple_sfn_project.truth_table,
        url=simple_sfn_project.google_sheet_url,
    )
...
def publish_lambda_layer(
    ...
    return simple_lambda_project.publish_lambda_layer(
        ...
        check=check,
        step=simple_sfn_project.StepEnum.publish_lambda_layer.value,
        truth_table=simple_sfn_project.truth_table,
        url=simple_sfn_project.google_sheet_url,
    )
...
def deploy_app(
    ...
    return simple_sfn_project.deploy_app(
        semantic_branch_name=git_repo.semantic_branch_name,
        runtime_name=runtime.current_runtime_group,
        env_name=detect_current_env(),
        pyproject_ops=pyproject_ops,
...
def delete_app(
    ...
    if runtime.is_local:
        ...
        skip_prompt = True
    skip_prompt = True  # uncomment this if you always want to skip prompt
    return simple_sfn_project.delete_app(
        semantic_branch_name=git_repo.semantic_branch_name,
        runtime_name=runtime.current_runtime_group,
        env_name=detect_current_env(),
        pyproject_ops=pyproject_ops,
        ...
        skip_prompt=skip_prompt,
        check=check,
        step=simple_sfn_project.StepEnum.delete_cdk_stack.value,
        truth_table=simple_sfn_project.truth_table,
        url=simple_sfn_project.google_sheet_url,
    )
...
def run_int_test(check: bool = True):
    ...
    simple_lambda_project.run_int_test(
        ...
        wait=wait,
        check=check,
        step=simple_sfn_project.StepEnum.run_integration_test.value,
        truth_table=simple_sfn_project.truth_table,
        url=simple_sfn_project.google_sheet_url,
    )
...
def create_config_snapshot(check: bool = True):
    simple_config_project.create_config_snapshot(
        ...
        check=check,
        step=simple_sfn_project.StepEnum.create_artifact_snapshot.value,
        truth_table=simple_sfn_project.truth_table,
        url=simple_sfn_project.google_sheet_url,
    )
...
def delete_config(check: bool = True):
    simple_config_project.delete_config(
        ...
        check=check,
        step=simple_sfn_project.StepEnum.delete_config.value,
        truth_table=simple_sfn_project.truth_table,
        url=simple_sfn_project.google_sheet_url,
    )
