...
2. ``dynamodbsnaplake/iac/define/lbd.py``: This is the CDK stack code where we declare the ``LIVE`` alias and use the value defined in ``"*.lambda_functions.*.live_version"`` as the target version.

.. literalinclude:: ../../../../dynamodbsnaplake/iac/define/lbd.py
   :language: python
