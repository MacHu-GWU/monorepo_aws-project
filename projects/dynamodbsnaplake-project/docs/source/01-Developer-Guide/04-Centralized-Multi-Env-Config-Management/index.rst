...
Below are the list of important files related to config management::
    ...
    ${HOME}/.projects/dynamodbsnaplake/config-secret.json # include the sensitive config data, the ${HOME} is your user home directory
...
.. literalinclude:: ../../../../dynamodbsnaplake/config/init.py
   :language: python
