...
"""
For multi-environments project, we use
`config_patterns <https://github.com/MacHu-GWU/config_patterns-project>`_
library to manage the configuration declaration and loading.
