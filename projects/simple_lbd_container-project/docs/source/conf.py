# -*- coding: utf-8 -*-
#
# simple_lbd_container documentation build configuration file, created by
...
import simple_lbd_container as package
...
# Add data for Jinja2
try:
    from simple_lbd_container.docs import doc_data
except:
    doc_data = dict()
