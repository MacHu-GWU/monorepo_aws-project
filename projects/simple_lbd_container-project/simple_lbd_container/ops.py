...
def deploy_config(check: bool = True):
    simple_config_project.deploy_config(
        ...
        check=check,
        step=simple_lbd_container_project.StepEnum.deploy_config.value,
...
def run_unit_test(check: bool = True):
    simple_python_project.run_unit_test(
        ...
        check=check,
        step=simple_lbd_container_project.StepEnum.run_code_coverage_test.value,
        truth_table=simple_lbd_container_project.truth_table,
        url=simple_lbd_container_project.google_sheet_url,
    )
...
def build_doc(check: bool = True):
    ...
    simple_python_project.build_doc(
        ...
        pyproject_ops=pyproject_ops,
        check=check,
        step=simple_lbd_container_project.StepEnum.build_documentation.value,
        truth_table=simple_lbd_container_project.truth_table,
        url=simple_lbd_container_project.google_sheet_url,
    )
...
def deploy_versioned_doc(check: bool = True):
    ...
    simple_python_project.deploy_versioned_doc(
        ...
        check=check,
        step=simple_lbd_container_project.StepEnum.update_documentation.value,
        truth_table=simple_lbd_container_project.truth_table,
        url=simple_lbd_container_project.google_sheet_url,
    )
...
def deploy_app(
    ...
    return simple_lambda_project.deploy_app(
        ...
        check=check,
        step=simple_lbd_container_project.StepEnum.deploy_cdk_stack.value,
        truth_table=simple_lbd_container_project.truth_table,
        url=simple_lbd_container_project.google_sheet_url,
    )
...
def delete_app(
    ...
    return simple_lambda_project.delete_app(
        ...
        skip_prompt=skip_prompt,
        check=check,
        step=simple_lbd_container_project.StepEnum.delete_cdk_stack.value,
        truth_table=simple_lbd_container_project.truth_table,
        url=simple_lbd_container_project.google_sheet_url,
    )
...
def publish_lambda_version(
    ...
    return simple_lambda_project.publish_lambda_version(
        ...
        lbd_func_name_list=config.env.lambda_function_name_list,
        check=check,
        step=simple_lbd_container_project.StepEnum.publish_new_lambda_version.value,
        truth_table=simple_lbd_container_project.truth_table,
        url=simple_lbd_container_project.google_sheet_url,
    )
...
def run_int_test(check: bool = True):
    ...
    simple_lambda_project.run_int_test(
        ...
        wait=wait,
        check=check,
        step=simple_lbd_container_project.StepEnum.run_integration_test.value,
        truth_table=simple_lbd_container_project.truth_table,
        url=simple_lbd_container_project.google_sheet_url,
    )
...
def create_config_snapshot(check: bool = True):
    simple_config_project.create_config_snapshot(
        ...
        check=check,
        step=simple_lbd_container_project.StepEnum.create_artifact_snapshot.value,
        truth_table=simple_lbd_container_project.truth_table,
        url=simple_lbd_container_project.google_sheet_url,
    )
...
def delete_config(check: bool = True):
    simple_config_project.delete_config(
        ...
        check=check,
        step=simple_lbd_container_project.StepEnum.delete_config.value,
        truth_table=simple_lbd_container_project.truth_table,
        url=simple_lbd_container_project.google_sheet_url,
    )
