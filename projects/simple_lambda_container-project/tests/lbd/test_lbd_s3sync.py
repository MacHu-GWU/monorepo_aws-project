...
import moto
from simple_lambda_container.logger import logger
from simple_lambda_container.config.api import config
from simple_lambda_container.lbd.s3sync import low_level_api
from simple_lambda_container.tests.mock import BaseMockTest
...
if __name__ == "__main__":
    ...
    run_cov_test(__file__, "simple_lambda_container.lbd.s3sync", preview=False)
