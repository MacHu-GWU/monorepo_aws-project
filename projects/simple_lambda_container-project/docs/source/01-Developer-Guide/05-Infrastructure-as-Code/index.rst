...
------------------------------------------------------------------------------
1. Working on ``simple_lambda_container/iac/`` module to declare your CDK stack.
