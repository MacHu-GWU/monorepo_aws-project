...
from simple_deploy_gate.lbd.add_one import Counter, low_level_api
from simple_deploy_gate.tests.mock_aws import BaseMockAws
...
if __name__ == "__main__":
    ...
    run_cov_test(__file__, "simple_deploy_gate.lbd.add_one", preview=False)
