...
Below are the list of important files related to config management::
    ...
    ${HOME}/.projects/simple_deploy_gate/config-secret.json # include the sensitive config data, the ${HOME} is your user home directory
...
.. literalinclude:: ../../../../simple_deploy_gate/config/load.py
   :language: python
